...
var revealOnScrollFeatures = new _RevealOnScroll2.default((0, _jquery2.default)('.feature-item'), '85%');
...
//npm modules are already in path?
...
var StickyHeader = function () {
	...
	//refresh waypoints whenever a lazyload image is loaded
				...
				new Waypoint({
					...
					handler: function handler(direction) {
						if (direction == 'down') {
							...
							var matchingHeaderLink = (0, _jquery2.default)(currentPageSection).data('matching-link');
